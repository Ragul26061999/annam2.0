...
export default function RadiologyTransactionsPage() {
  ...
  const loadRecords = async () => {
    try {
      ...
      // Filter only radiology records
      const radiologyRecords = result.records.filter(record => record.source === 'radiology');
      setRecords(radiologyRecords);
      setTotalRecords(radiologyRecords.length);
    } catch (error) {
      console.error('Error loading radiology records:', error);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Radiology & Scan Transactions</h1>
            <p className="text-gray-500 mt-1">View and manage all radiology and X-ray billing transactions</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search by scan ID, patient name..."
              value={searchTerm}
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-600">
            Showing {records.length} radiology & scan transactions
          </p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              {records.map((record) => (
                <tr key={record.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-xs text-orange-600">Radiology</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
        ...
        {records.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No radiology transactions found</h3>
